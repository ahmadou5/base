...
import { core, BaseG, flaming } from './images'
...
const BaseBanner = () => {
  ...
  return (
    <S.Wrapper
      style={{
        background: `linear-gradient(128.04deg, #FFFFFF -80.79%, #0066FF  102.4%)`,
    ...
    >
      <S.Inner>
        <S.LeftWrapper>
          ...
          <AptosTitle>{t('Gm Base Team!')}</AptosTitle>

          <Button
            minHeight="48px"
            onClick={() =>
              window?.open('https://base.flamefinance.org')
            }
          >
