...
import { bscTokens, bscTestnetTokens, USDC, USDT,  WBTC_ETH, coreTokens, baseTokens } from '@pancakeswap/tokens'
...
export const ROUTER_ADDRESS: ChainMap<string> = {
  ...
  [ChainId.CORE]: '0x6B9e34b56504B33468dACbb6D37b79C1b4D3B70E',
  [ChainId.BASE_G]: '0x0b9e480696d354Fc4103f9a8D62D2d9e2672A152',
}
...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  ...
  [ChainId.CORE]: [coreTokens.wcore, coreTokens.flame, coreTokens.aicore],
  [ChainId.BASE_G]: [baseTokens.weth, baseTokens.flame]
}
...
export const SUGGESTED_BASES: ChainTokenList = {
  ...
  [ChainId.BSC_TESTNET]: [bscTestnetTokens.wbnb, bscTestnetTokens.cake, bscTestnetTokens.busd],
  [ChainId.CORE]: [coreTokens.flame, coreTokens.wcore, ],
  [ChainId.BASE_G]: [baseTokens.weth, baseTokens.flame]
}
...
export const BASES_TO_TRACK_LIQUIDITY_FOR: ChainTokenList = {
  ...
  [ChainId.BSC_TESTNET]: [bscTestnetTokens.wbnb, bscTestnetTokens.cake, bscTestnetTokens.busd],
  [ChainId.CORE]: [coreTokens.wcore, coreTokens.flame],
  [ChainId.BASE_G]: [baseTokens.weth, baseTokens.flame]
}
...
export const PINNED_PAIRS: { readonly [chainId in ChainId]?: [Token, Token][] } = {
  ...
  [ChainId.CORE]: [
    [coreTokens.wcore, coreTokens.flame],
    [coreTokens.wcore, coreTokens.aicore]
  ],
  [ChainId.BASE_G]: [
    [baseTokens.weth, baseTokens.flame],
